...
app = Flask(__name__)
DATABASE = 'faqs.db'
MENSAJE_BIENVENIDA = "¡Hola! Bienvenido al chatbot de Compensar. ¿En qué puedo ayudarte hoy?"
...
def index():
    ...
    return render_template('index.html', historial=historial, mensaje_bienvenida=MENSAJE_BIENVENIDA)
